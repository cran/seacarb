...
bor = (416.*(S/35.))* 1e-6;   # (mol/kg), DOE94   
	...
	# ------------------- Pression effect --------------------------------
		...
		a2 = c(0.0, 0.0, -2.608*1e-3, -3.6246*1e-3, 0.316*1e-3, -0.942*1e-3, 0.0, 0.0, -0.321*1e-3, -2.647*1e-3, -3.042*1e-3); ## to be consistent with Millero (1979) a2 was changed to -2.608*1e-3 instead of 2.608*1e-3 (value given in Millero, 1995)
